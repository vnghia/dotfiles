# Generated by Powerlevel10k configuration wizard on 2022-01-26 at 22:36 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%F{124}⟨ '
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%B%F{196}λ%f%b'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%F{124}⟩%f'
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="%F{209}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}%f"
    fi
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=81
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION='%F{143}py%f'
